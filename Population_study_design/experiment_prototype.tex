...
%TCIDATA{LastRevised=Monday, March 13, 2017 09:41:19}
...
In our experiment, we will use master sets of objects from many different
choice domains. See Section \ref{s:domains} for some examples. In all cases,
the master set contains five objects.

\section{Experimental Design}

\label{s:design}

Our experiment has $J$ domains, each with a master set of size five. There
are $I = 2^5 - 5 - 1 = 26$ non-degenerate (i.e. having at least two
elements) choice sets for each domain. Each non-degenerate choice set is
presented once to a number $N$ of the participants, and there are a total of 
