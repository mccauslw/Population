...
\veryHuge \color{NavyBlue} \textbf{Testing axioms of stochastic discrete choice\\using population choice probabilities} \color{Black}\\ % Title
%\Huge\textit{An Exploration of Complexity}\\[1cm] % Subtitle
\huge \textbf{William McCausland \& Tony Marley \& Clintin David-Stober}\\ % Author(s)
\huge University of Montreal, Victoria University and University of Missouri\\ % University/organization
\end{minipage}
%
\begin{minipage}[b]{0.25\linewidth}
\color{DarkSlateGray}\Large \textbf{Contact Information:}\\
Department of Economcis\\ % Address
University of Montreal\\
%123 Broadway, State, Country\\\\
Phone: (514) 575-0418\\ % Phone number
Email: \texttt{william.j.mccausland@umontreal.ca}\\ % Email address
\end{minipage}
%
